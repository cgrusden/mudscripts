#TRAVEL SCRIPT 1/23/2013
# -- Updated for DragonRealms 3.0 by Nikpack and Isharon
# -- Spelling errors corrected by Isharon
# -- edited by Isharon to accommodate the new shorter transport times
# -- edited by Nikpack to accommodate the DR 3.0 changes
# -- The official version of this script available at
# -- http://www.kraelyst.com/travel
# -- A copy with bug fixes can be found at
# -- http://elanthipedia.org/w/index.php/Travel_%28script%29
...
ECHO * * * Only the first 3 letters of the destination need to be inputted
...
ECHO
ECHO
ECHO * * * Passing by the manor of Lasarhhtha Oshu'ehhrsk the Bone Dancer
...
ECHO *** The ferry takes two minutes to cross the river.
ECHO
pause 15
ECHO
ECHO ====================================
...
ECHO
ECHO * * * When the Empire collapsed Lanival The Redeemer fought Teiro
...
ECHO *** Capital of the province of Zoluren
...
ECHO
ECHO
ECHO * * * Northward is a monastery surrounded by gargoyles and death spirits and a bramble full of badgers and trollkins
ECHO
move ne
move e
move ne
...
ECHO *** Westward is the Journalai Route towards the Journalai mountains, inhabited by rock trolls
ECHO ===================
ECHO
goto finish
...
ECHO *** A large traveler's outpost at the border between Zoluren and Therengia
ECHO ===================
ECHO
GOTO %1
...
ECHO
ECHO ===================
ECHO *** DIRGE, formerly known as DARKSTONE
...
CANTSWIM3:
ECHO
ECHO *** YOU DO NOT HAVE ENOUGH ATHLETICS FOR THE FALDESU (120 ranks)
ECHO *** TAKING THE FERRY
ECHO
goto MONEYCHECK3
...
ECHO *** The ferry takes three minutes to cross the river.
ECHO
pause 30
ECHO
ECHO ====================================
...
pause
ECHO
ECHO *** Riding the barge down the Faldesu River towards Throne City, capital of the former Seven-Starred Empire
ECHO
put hide
pause
waitfor crew quickly ties the barge off.
...
ECHO
ECHO *** THRONE CITY
ECHO *** The ancient capital of the Seven-Pointed Star Empire, on the banks of the Faldesu Delta
...
ECHO *** With no burden you need 140 athletics ranks for the Rossman's route.
ECHO ==============================================
ECHO
pause
GOTO RIV-BAR
...
ECHO *** You need more perception (140+) or athletics (140+)
ECHO
...
ECHO *** The trip takes seven minutes.
ECHO
pause 90
ECHO
ECHO ====================================
...
ECHO ===================
ECHO *** FORNSTED
ECHO *** Located in the Ker'Leor Forest atop the Ker'Leor mountains
...
ECHO ========================================
ECHO *** You cannot take the Rossman's Landing shortcut because you either
ECHO *** Have a group OR need more perception (140+) or athletics (100+)
ECHO
ECHO ***  TAKING THE BARGE INSTEAD   ***
ECHO ========================================
ECHO
...
ECHO =================================
echo *** Common Knowledge: 2 of 2
ECHO * * * Akroeg's son Verek was anointed the first emperor
...
ECHO * * * Home to the Olvi from the badlands to the northwest, who built the Halfling Quarter in town.
ECHO ===================
ECHO
goto %1
...
ECHO
ECHO ==============================
ECHO *** You do not have enough perception (140) or athletics (100), which are required to take the shortcut from Rossman's to Riverhaven, nor do you have the 50 ranks of athletics required to get from Rossman's to Therenborough.  You must rent a boat to sail on Lake Gwenalion, moongate out, or find someone to help you.
ECHO ==============================
ECHO
EXIT
...
ECHO
ECHO ============================
ECHO *** You don't have enough perception (140) or athletics (100) to take the shortcut from Rossman's to Riverhaven.
...
pause
ECHO
ECHO *** Riding the ferry south across the Faldesu River, which takes three minutes.
ECHO *** This ferry is operated by House Shillat, one of the 16 Therengian great houses (or Morzindaen)
ECHO
pause
waitfor crew ties the ferry off.
...
ECHO * * * He spoke of a twisted forest of mist and darkness and misshappen fae
...
ECHO * * * gondola (approximately 540 base ranks of athletics) type SHORTCUT1
ECHO
pause
put look gondola
...
ECHO
ECHO *** The gondola takes three minutes to cross the chasm. It no longer slows down when a caravan is on board.
ECHO ================================
ECHO
pause 30
ECHO
...
ECHO * * * Capital of Ilithi and the Elothean nation, governed by an Elothean Ferdahl
...
ECHO *** The wife of the chieftain is called Carwu Taipen, Elven for "Heart of the Clan"
...
ECHO ===================
ECHO *** SHARD, the Crystal City built upon the Lake of Tears
ECHO * * * Capital of Ilithi and the Elothean nation and home to Elves, governed by an Elothean Ferdahl
ECHO * * * Built first by Elothean Corik the Black Cloud and Queen Morganae of the Mountain Elves
...
ECHO * * * gondola (approximately 150 base ranks of athletics) type SHORTCUT1.
...
ECHO * * * Patron god is Botolf the goshawk, dark aspect of Chadatru, god of dishonesty and deceit and patron of thieves guilds and fallen paladins.
ECHO ===================
ECHO
GOTO FINISH
...
ECHO *** The Journalai Mountains loom to the north while the Himineldar Shel Mountains shade the south
ECHO
pause 90
ECHO
ECHO ====================================
...
OVERBURDENED12:
ECHO
ECHO *** You do not have enough athletics with your current burden to pass through Archer's Ford to Boar Clan.  Lose some weight and try again!
ECHO
...
CANTSWIM12:
ECHO
ECHO *** You do not have enough athletics (20) or Strength (16) to pass through Archer's Ford to Boar Clan.  Find someone to drag you or cast some athletics buffs.
ECHO
ECHO * * * If you think this assessment is wrong or you have abnormally high strength or spells, then you can continue on to Boar Clan by typing GLANCE now.  If you can make it to Boar Clan and back to Hibarnhvidar let me know what your athletics and strength are (kraelyst@hotmail.com)!
match cont-hib-boa You glance
ECHO
match cont-hib-boa You glance
matchwait
...
move nw
ECHO
ECHO * * * Now wading across Archer's Ford in the Biiskbowr River, which flows from the Journalai Mountains to Sawstwar Lake.
ECHO
hib-boa-groupcheck:
pause
...
ECHO * * * If you can make it through Archer's Ford please let me know what your athletics and strength are (kraelyst@hotmail.com)!
ECHO
...
CANTSWIM13:
ECHO
ECHO *** You do not have enough athletics (20) or Strength (16) to pass through Archer's Ford south of Boar Clan.  Find someone to drag you or cast some athletics buffs.
ECHO
...
pause
ECHO
ECHO *** The Gear Gate is closed for the night and you do not have enough athletics skill (25) to bypass the gate.  You'll have to wait until day, learn more athletics, or get some help.
ECHO
...
ECHO * * * Therenborough, El'Bain's, Langenfirth, Fornsted, Hvaral, Muspar'i
ECHO
ECHO
...
ECHO
ECHO ==============================
ECHO *** You do not have the 50 ranks of athletics required to get to Rossman's.
